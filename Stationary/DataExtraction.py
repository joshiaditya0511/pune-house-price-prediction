...
INPUT_DIRECTORY = os.path.join(BASE_DIR, 'Data', 'propertyDetails')
...
if __name__ == '__main__':
    ...
    output_path = os.path.join(OUTPUT_DIRECTORY, 'rawExtractedPropertyDetails.csv')
